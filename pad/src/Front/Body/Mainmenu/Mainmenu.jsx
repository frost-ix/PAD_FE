  ...
  return (
    <div className="LoginAfter">
      ...
      <div className="popular">
        {Session.memNN ? (
          <h1>
            {Session.memNN}님, <strong>PAD</strong>에 오신것을 환영합니다!
          </h1>
        ) : (
          <h1>
            <strong>PAD</strong>에 오신것을 환영합니다!
          </h1>
        )}
      ...
      <div className="notice">
        ...
        <div className="button-area">
          <div className="button-value">
            <button className="question" onClick={() => navigate("/question")}>
              <i className="bx bx-question-mark"></i>
              <br />
              자주묻는질문
            </button>
            <button className="company-info" onClick={() => navigate("/company")}>
              <i class="bx bxs-buildings"></i>
              <br />
              회사정보
            </button>
            <button className="call" onClick={calling}>
