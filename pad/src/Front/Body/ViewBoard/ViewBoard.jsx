        ...
        <div className="ViewBoard">
          ...
          {boardIDinfo ? ( // boardIDinfo가 로드되었을 때만 화면에 출력
            ...
            <div className="ViewBoardBar">
                ...
                <button className='viewbutton' onClick={() => {navigate("/");}}>삭제</button>
                <button className='viewbutton' onClick={() => {navigate("/");}}>생성</button>
                <button className='viewbutton' onClick={() => {navigate("/HBoard");}}>돌아가기</button>
